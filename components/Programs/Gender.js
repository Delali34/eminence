...
function Leadership() {
  return (
    <div>
      <div id="Gender">
        <div className="relative  h-full  bg-[#f54b35] border-2 border-black mt-10">
          <div className="relative p-10 px-5  bg2   right-2 bottom-2 border-2 border-black h-full">
            ...
            <div className="font-maintext mt-5  pt-5 bg-white p-4 rounded-lg border-[#f54b35] border-[1px]">
              ...
              <p className="font-mont">
                ...
                actively and effectively in the political sphere. It provides
                training, mentorship, and resources to women aspiring to enter
                politics, run for office, or engage in political leadership
                roles. The aim is to increase the representation of women in
                decision-making positions and policy formulation, ensuring their
                voices are heard and their perspectives are integrated into
            ...
            <div className="font-maintext mt-5  pt-5 bg-white p-4 rounded-lg border-[#f54b35] border-[1px]">
              ...
              <p className="font-mont">
                ...
                enterprises. It provides guidance and resources to help women
                navigate the process of registering and legitimizing their
                businesses. Formalizing these enterprises enhances their
                credibility, access to markets, funding, and opportunities for
                growth. Moreover, it promotes fair treatment, legal protection,
            ...
            <div className="font-maintext mt-5  pt-5 bg-white p-4 rounded-lg border-[#f54b35] border-[1px]">
              ...
              <p className="font-mont">
                ...
                self-esteem, enhancing life skills, and providing mentorship. It
                addresses issues such as health education, financial literacy,
                gender rights, and career guidance. By empowering adolescent
                girls, the program prepares them for adulthood, encouraging them
                to aspire for a future with equal opportunities and choices.
              </p>
            </div>
            <div className="font-maintext mt-5  pt-5 bg-white p-4 rounded-lg border-[#f54b35] border-[1px]">
              <h1 className="lg:text-3xl text-xl font-semibold pb-3">
