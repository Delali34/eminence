export const Team = [
  ...
  },
  {
    ...
    position: " Project Officer",
    details:
      "Emmanuel Gyan is an accomplished Earth Scientist and an Environmentalist with years of experience. Emmanuel has the ability to take unhealthy portfolios and transform them into healthy and thriving ones, produce productive and long-lasting results for high-level clients. He has a working experience from major companies, non-profit organisations, and hospitals. Emmanuel works well with senior corporate executives, provide consultations for international corporations and effective at persuading and influencing high-ranking individuals for work done.",
    details2:
  ...
  // },
  {
    ...
    details:
      "Dorinda Afloe has provided excellent attention to detail and has effectively represented the face of the organisation. Working in close coordination with all staff in the organisation. Dorinda has proven to be indispensable in organizing scheduling, managing schedules and resources while innovating successful programs to improve office support. Her contributions toward improving and eventually over handling the office correspondence systems to more effectively communicate within and outside the organisation. ",
    details2:
      "Dorinda has brought years of experience in her to the field non-profit organisation. She has worked with several institutions in Ghana such as non-profit organisations, schools, credit unions and associations. She has cultivated a harmonious and fastidious work environment with the non-profit organisation field that allows her to graciously represent the face of our Administration as an assistant. Dorinda is a fast learner and loves to inspire other to leave a purposeful life. Dorinda is an alumni of the Methodist University College, Accra Ghana.",
    details3: "",
  },
  {
    ...
    details3:
      "Her role as program officer, Hannah plays a crucial role in shaping the future of organisation and driving innovation and growth. Her dedication, expertise, and passion for excellence make her a valuable asset to our team and a key driver of our continued success. She has been engaged in community mobilization and development with special Interest in human development with specific focus on the girl child. Hannah is an experienced program officer years of working with United Bank of Africa, Accra Ghana as Customer Relations Officer and at Ghana Cocoa Board, Quality Control and Human Resource Department as an officer. Hannah loves sports and listening to music",
  },
  {
    name: "Cyril Dogbe",
    image: "/cyril.jpeg",
