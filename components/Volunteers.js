...
function Page() {
  ...
  return (
    <div className="bg5">
      <Navbar2 />
      <Mobilebar />
      <section className="flex flex-col gap-10 justify-between items-center px-5 font-mont container mx-auto lg:px-10 py-10">
            ...
            <div className="container mx-auto text-center">
              <div className="mt-4 m-10">
                <input
                  ...
                  required
                  id="firstname"
                  className="w-full bg-white text-primary border-2 border-gold rounded-lg p-3 text-lg focus:outline-none focus:border-opacity-50"
              ...
              <div className="mt-4 m-10">
                <input
                  ...
                  required
                  id="email"
                  className="w-full bg-white text-black border-2 border-gold rounded-lg p-3 text-md focus:outline-none focus:border-opacity-50"
              ...
              <div>
                ...
                <div className="flex p-4 flex-wrap justify-center gap-4">
                  <button
                    ...
                    className="bg-white text-primary hover:bg-opacity-80 py-3 px-6 rounded-lg text-md text-black font-semibold transition duration-300"
                  >
                    Public Speaking
                  </button>
                  <button
              ...
              <div className="mt-4 m-10">
                ...
                <div className="flex justify-center">
                  <div className="bg-white w-[130px] mt-2 font-semibold rounded-xl hover:bg-black cursor-pointer hover:text-white p-3">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-1">Selected Skills</h3>
                <div className="flex p-4 flex-wrap justify-center gap-4">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-1">Selected Interest</h3>
                <div className="flex p-4 flex-wrap justify-center gap-4">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4">Days Available</h3>
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4">Selected Days</h3>
              ...
              <div className="flex justify-center">
                <div className="bg-white w-[130px] font-semibold mt-5 rounded-xl hover:bg-black cursor-pointer hover:text-white p-3">
