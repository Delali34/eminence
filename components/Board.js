export const Board = [
  ...
  },
  {
    ...
    position: "Board Member",
    details:
      "Hon. Abass Malik is a Politician, Educationist, Entrepreneur and Disaster Management and Control Expert. He has fifteen (15) years’ of experience in school management as an educationist and head of school from basic to secondary levels of education in both private and public schools. He has contributed to the education system of Ghana, especially at where he worked as an educationist and head of school. Some of his contributions include student performances in academics, life skills development and psychology.  He has contributed massively in the education system of Ghana including teacher transformation initiatives, school infrastructures and access to education especially for the deprived communities cross Ghana.  Hon. Abass Malik is the Director of Operations at the National Disaster Management organisation (NADMO) at the Ga West Municipal Assembly. He is responsible for disaster prevention and mitigation, community education on disaster prevention, poverty alleviation and conflict resolution. He has seventeen (17) electoral areas under his watch as a Director of Operations at the Ga West Municipality.",
    details2:
      "He has helped to reduce disaster, poverty, conflict and increased community development for the past decade in seventeen (17) electoral areas in the Ga West Municipality. As a non-partisan politician, he focuses on education, youth development, leadership and governance, entrepreneurship and community development. In the past decade he has worked tirelessly to reduce educational challenges, community challenges, health, and poverty in the communities. He has contributed to the welfare of the people in the various communities, Hon. Abass Malik is a kind of a person from a different planet; he understands humanity and he has the passion to inspire and put smiles on the faces of his people. As an entrepreneurship facilitator, youth empowerment activist, he always organises community programs about education, skill training, community development and poverty mitigation planning to empower the youth and the entire community for a better living.  Hon. Abbas Malik is an aluminus of the University of Cape Coast. He holds a BSc in Education, Masters in Education, Diploma in Education and other professional qualifications for facilitation, mentorship, management and administration. Hon. Malik loves politics as non-partisan, public engagement, football and driving mostly in a serene environment. He is married with three (3) amazing children.",
  },
  {
    ...
    position: "Board Member",
    details:
      "Dr. Daniel Andrews Kumi-Ntreh is a counselor, lecturer, conference speaker, teacher, preacher and trainer. His passion is to become God's instrument for affecting his generation in all areas of life. He is the Secretary General of the Apostolic Ministerial International Network. An organisation that trains, counsels, ordain, and equip men and women who have the call of God on their lives. Dr. Daniel Andrews Kumi-Ntreh is a Registrar and a lecturer at the Kingdom Excellence Leadership Institute, South Africa and founder of Royal Christian Centre. He is an experienced lecturer in leadership, theology, entrepreneurship, counseling, christian life, governance and development. He has nineteen (19) years’ experience as a leadership lecturer, a theologist, consultant, preacher, conference speaker and a trainer.",
    details2:
  ...
  },
  {
    ...
    position: "Board Member",
    details:
      "Mr. Ebenezer Kobina Buabeng  is an experienced insurance manager and marketing expert for decade. He has practiced insurance for the past 15years, worked with Provident Insurance as a senior sales manager for 7 years, driven competition standard to developed marketing leading services, improved client’s retention on business growth. He has extensive background in people management and coaching in sales environment.",
    details2:
      "Mr. Buabeng has been working for Old Mutual life insurance for the past 8 years as an Area Manager for the southern sector of Ghana. Mr. Buabeng's interests lie in human capital development, life coaching, entrepreneurship coaching, corporate managerial, international business consultancy and program facilitation. He holds several qualification to his credit which includes degree, certificates, masters and PhD from the university and Insurance college of Ghana. Mr. Buabeng loves nature and enjoys hiking, swimming, reading and listening to world news.",
    // details3:
  ...
  },
  {
    ...
    position: "Board Member",
    details:
      "Dr. Ekobor-Ackar Eric is a Development Economist and a Lecturer at Ghana Communication Technology University. His research focuses on Financial Technology (FinTech) ecosystem especially on Mobile Money technology in Ghana and Africa. He was a Fox International Fellow at Yale University and a PhD Fellow with UNU-WIDER at Helsinki, Finland. Dr. Mochiah has lectured in Economics since 2011.",
    details2:
      "He is a former employee of Institute of Statistical, Social and Economic Research (ISSER) and has worked on multiple economic surveys and interventions including MCC-MiDA Interventions, Ghana Social Opportunities Project, LEAP Project, World Bank Land Titling Project and many others. He has consulted for and assisted various institutions (World Bank, AGRA, MDF West Africa, EMOS consultancy, Ernst and Young and many others.) which work directly with local government on national and transnational projects. He is on the side, an astute businessman in the transport industry (Car Rental Agency) with over 12 years of experience.",
  },
  {
